export default function EditAds() {
  return (
    <div className="bg-white rounded-[20px]">
      <div className="p-4">
        ...
        <div className="flex items-center space-x-8 rtl:space-x-reverse mt-20 mr-6">
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            ...
            <div className="flex items-center w-[160px] h-10 border border-gray-300 rounded-lg px-2 bg-white">
              <input
                type="text"
      ...
      <div className="bg-blue-500 w-[109px] h-12 mr-[930px] mt-[60px] rounded-xl text-white items-center flex justify-center">
        <button>ثبت</button>
      </div>
    </div>
  );
